/** All 50 states + DC, for the jurisdiction selector. Selecting a state is
 * purely informational in this milestone (see templates/index.ts) — no
 * state-specific legal content exists yet. */
